  ...
  <div class="min-h-screen w-full bg-gray-100">
    <div class="container mx-auto px-4 py-6">
      ...
      <div class="flex flex-col lg:flex-row gap-6">
        ...
        <!-- Job Listings -->
        <main class="flex-1">
          <div v-if="filteredJobs.length" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
            ...
            >
            <nuxt-link :to="`/admin/jobs/${job.title }`">
              <div class="bg-white border-2 border-black rounded-lg overflow-hidden hover:shadow-lg transition">
          ...
          <div v-else class="flex items-center justify-center h-64">
            ...
            <aside class="w-full lg:w-70 bg-white border-2 border-black rounded-lg p-4 h-fit">
